...
from src.arbirich.io.exchange_processors.registry import get_processor_class
...
def get_processor_for_exchange(exchange: str) -> Type[BaseOrderBookProcessor]:
    ...
    from src.arbirich.io.exchange_processors.registry import _processor_registry
